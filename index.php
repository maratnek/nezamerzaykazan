	...
	<div class="content">
		<div class="header_main">
			<header class="top_header">
				<div class="col-md-12">
					<div class="logo">
						<img src="img/logo.png" height="80" width="80" alt="logotype">
					</div>
					<div class="communic">
						<i class="fa fa-phone"></i>
						8-(927)-43-05-986
						<a href="https://vk.com/nezamerzaykazan"><i class="fa fa-vk"></i></a>
					</div>
				</div>
			</header>
			<div class="home">
				<div class="row">
					<div class="col-md-8">
						<h1>Незамерзайка от производителя</h1>
					</div>
					<div class="col-md-4">
						<div class="callback">
